...
### 面试回忆录
1. 自我介绍
面试官，您好，我叫XX，2014年本科毕业，毕业后一直在XX公司从事Java后端的开发和项目的实施交付。因为自己敢拼，能抗住压力，因此有机会在工作的第三年慢慢开始作为技术leader带领团队做项目的开发，到现在为止由我独立完成项目的架构设计，开发，交付的项目有2个，其中一个项目是大型的分布式集群项目，我自己在这个项目中的成长是非常快的，自己对项目的开发计划把控和带人方面的理解，技术的深度也是在这个项目积累的。我的技术栈积累在Java系列，Java基础，多线程，JVM，SpringBoot全家桶，SpringCloud，熟练常用的设计模式，一些中间件，如Redis, RabbitMQ, Nginx, Keepalived，MyBatis等，常用的数据库是MySQL，对Linux服务器上的部署和运维也搞过好几个项目。我自己学习和努力的方向是SASS和PASS平台的建设。我离职的原因主要是平台的原因。目前所在的公司主要是以接项目为主，自己在技术和项目的广度上有所积累，但我觉得深度不够。我想去一家互联网公司，大一点的公司，来开阔自己的视野，提升自己的能力（T型人）。我目前的状态是处于一个比较稳定能很拼的状态，这个稳定是自己的家庭很稳定，已经在武汉安家了，另外就是我心态很稳定，我知道自己要什么，自己的职业规划也是很清晰的，并且我能够持之以恒的去坚持，这一点可以从我Github的提交历史来看到，在过去的365天中，我有356天都有在输出自己对技术知识的梳理和总结。OK，以上我就我的项目经历，个人技术栈，离职原因和目前自己的状态做了介绍，面试官就这些了。
